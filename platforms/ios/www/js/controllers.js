angular.module('bil_app.controllers', [])
...
.controller('HomeCtrl', function($scope, $rootScope, $state, $ionicLoading, PostService) {
  ...
  return function(input) {
    return input.replace('ballislife.com', 'dsz7vodgjx60a.cloudfront.net');
  };
})

// EXCLUSIVE - GET Exclusive POSTS
.controller('ExclusiveCtrl', function($scope, $rootScope, $state, $ionicLoading, PostService) {
  $scope.posts = [];
  $scope.page = 1;
  $scope.totalPages = 1;
  ...
  $scope.doRefresh = function() {
    ...
    //Always bring me the latest posts => page=1
    PostService.getPostsFromExclusiveCategory(1)
    .then(function(data){
...
// High School - GET Exclusive POSTS
.controller('HSCtrl', function($scope, $rootScope, $state, $ionicLoading, PostService) {
  $scope.posts = [];
  $scope.page = 1;
  $scope.totalPages = 1;
  ...
  $scope.doRefresh = function() {
    ...
    //Always bring me the latest posts => page=1
    PostService.getPostsFromHSCategory(1)
    .then(function(data){
...
// NBA - GET Exclusive POSTS
.controller('NBACtrl', function($scope, $rootScope, $state, $ionicLoading, PostService) {
  $scope.posts = [];
  $scope.page = 1;
  $scope.totalPages = 1;
  ...
  $scope.doRefresh = function() {
    ...
    //Always bring me the latest posts => page=1
    PostService.getPostsFromNBACategory(1)
    .then(function(data){
...
// College - GET Exclusive POSTS
.controller('CollegeCtrl', function($scope, $rootScope, $state, $ionicLoading, PostService) {
  $scope.posts = [];
  $scope.page = 1;
  $scope.totalPages = 1;
  ...
  $scope.doRefresh = function() {
    ...
    //Always bring me the latest posts => page=1
    PostService.getPostsFromCollegeCategory(1)
    .then(function(data){
...
// VIDEOS - GET Exclusive POSTS
.controller('VideosCtrl', function($scope, $rootScope, $state, $ionicLoading, PostService) {
  $scope.posts = [];
  $scope.page = 1;
  $scope.totalPages = 1;
  ...
  $scope.doRefresh = function() {
    ...
    //Always bring me the latest posts => page=1
    PostService.getPostsFromVideosCategory(1)
    .then(function(data){
...
// Lifestyle - GET Exclusive POSTS
.controller('LifestyleCtrl', function($scope, $rootScope, $state, $ionicLoading, PostService) {
  $scope.posts = [];
  $scope.page = 1;
  $scope.totalPages = 1;
  ...
  $scope.doRefresh = function() {
    ...
    //Always bring me the latest posts => page=1
    PostService.getPostsFromLifestyleCategory(1)
    .then(function(data){
