angular.module('bil_app.services', [])
...
.service('PostService', function ($rootScope, $http, $q, WORDPRESS_API_URL, AuthService, BookMarkService){
  ...
  this.getPostsFromExclusiveCategory = function(categoryId, page) {
    var deferred = $q.defer();
  ...
  this.getPostsFromHSCategory = function(categoryId, page) {
    var deferred = $q.defer();
  ...
  this.getPostsFromNBACategory = function(categoryId, page) {
    var deferred = $q.defer();
  ...
  this.getPostsFromCollegeCategory = function(categoryId, page) {
    var deferred = $q.defer();
  ...
  this.getPostsFromVideosCategory = function(categoryId, page) {
    var deferred = $q.defer();
  ...
  this.getPostsFromLifestyleCategory = function(categoryId, page) {
    var deferred = $q.defer();
